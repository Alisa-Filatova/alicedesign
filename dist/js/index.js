...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__css_normalize_css__ = __webpack_require__(15);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__css_about_me_animation_css__ = __webpack_require__(18);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__css_about_me_animation_css___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_2__css_about_me_animation_css__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__less_index_less__ = __webpack_require__(19);
...
var girlBlinkAnim = new __WEBPACK_IMPORTED_MODULE_0_gsap_TweenMax__["a" /* TimelineLite */]();
...
var girlMainBlinkAnim = new __WEBPACK_IMPORTED_MODULE_0_gsap_TweenMax__["a" /* TimelineLite */]();
...
function scrollToAnchor(event) {
    ...
    var scrollTop = 0;
    var documentHeight = __WEBPACK_IMPORTED_MODULE_0_jquery___default()(document).height();
...
__WEBPACK_IMPORTED_MODULE_0_jquery___default()('.arrow').on('click', scrollToAnchor);
...
function init() {
    ...
    [].slice.call ( document.querySelectorAll( '#grid > a' ) ).forEach( function( el ) {
        var s = __WEBPACK_IMPORTED_MODULE_1_snapsvg_cjs___default()( el.querySelector( 'svg' ) ), path = s.select( 'path' ),
            pathConfig = {
                from : path.attr( 'd' ),
