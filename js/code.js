        ...
        items: [
            ...
            },
            {
                ...
                description: [
                    ...
                    'Личный проект на продвинутом интенсивном онлайн-курсе "Продвинутый HTML/CSS", в "HTML Academy".' ,
                    'Адаптивная верстка по готовому psd макету. Минимальная ширина: 320px. Технологии используемые в проекте:',
                    'HTML5/CSS3, Flexbox, препроцессор Less, методология БЭМ, JavaScript, Adobe Photoshop. Кроссбраузерность: IE10+.'
                ].join(' '),
            ...
            },
            {
                ...
                description: [
                    ...
                    ' Адаптивная верстка по готовому psd макету. Минимальная ширина: 320px.' ,
