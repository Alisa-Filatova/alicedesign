		...
		items: [
			{
				...
				description: [
					'<p><a class="text-link" href="https://www.wrike.com/" target="_blank" rel="noopener noreferrer">Wrike</a> - это платформа для управления проектами с большим количеством внутренних приложений, таких как менеджер задач, диаграммы Ганта, календари, отчеты, файл-менеджмент и многое другое.</p>' +
					'<p>Клиентами Wrike являются такие компании, как Apple, Microsoft, Sony, Siemens, P&G и многие другие.</p> ' +
