        ...
        items: [
            {
                ...
                tags: ['Фирменный стиль, Полиграфия']
            },
            {
...

            {
                ...
                thumbnail: ['img/graphic-design/small/36.jpg','img/graphic-design/small/16.jpg'],
                large: ['img/graphic-design/large/36.jpg','img/graphic-design/large/16.jpg'],
                img_title: ['jquery elastic grid', 'jquery elastic grid'],
                button_list: [
                    {
                        title: '',
...

            {
                title: '"Carpe Diem" - магазин постельного белья',
                description: [
                    'Магазин заказал у меня дизайн упаковок для постельного белья (детского и возрослого) и вкладыши с описанием ',
...

            {
                title: '"Carpe Diem" - магазин постельного белья',
                description: [
                    'Магазин заказал у меня дизайн упаковок для постельного белья (детского и возрослого) и вкладыши с ',
...

            {
                title: '"Carpe Diem" - магазин постельного белья',
                description: [
                    'Магазин заказал у меня дизайн упаковок для постельного белья (детского и возрослого) и ',
